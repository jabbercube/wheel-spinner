...
This RCA document should be used by `/github-bug-fix-implement-fix` skill.

## Next Steps

1. Review this RCA document
2. Run: `/github-bug-fix-implement-fix $ARGUMENTS` to implement the fix
